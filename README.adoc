...
Enter the following snippet into the Firefox console to pause a web page after 5 seconds.
...
Evaluate an XPATH as follows.

[,js]
----
$x("//div[starts-with(@class,'react-select__menu-list')]/div[starts-with(@class,'react-select-workType-option')]/div[text()='Novel']")
----
